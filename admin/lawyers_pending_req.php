 ...
 <body>
  ...
  <table>
    ...
    <tbody>
      <?php
        include "../config.php";
          $data1=mysqli_query($conn,"select * from lawyers_login where status='pending'");
          while($fetched_data1=mysqli_fetch_assoc($data1)){
            $uunm1=$fetched_data1['username'];
            $ustat=$fetched_data1['status'];
      ...
      <tr>
        ...
        <td><a class="btn btn-success" href="accept.php?ref=<?php echo $uunm1; ?>">Accept</a></td>
        <td><a class="btn btn-danger"  href="decline.php?ref=<?php echo $uunm1; ?>">Decline</a></td>
      </tr>
    <?php  } ?>
    </tbody>
  </table>
